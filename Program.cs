...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "Developed by Erismar Oliveira",
        Contact = new OpenApiContact { Name = "Erismar Oliveira", Email = "erismarpro@hotmail.com" },
...
.WithTags("Usuario");
        ...
        LoginUser loginUser) =>
    {
        ...
        var result = await signInManager.PasswordSignInAsync(loginUser.Email, loginUser.Password, true, false);
    ...
    app.MapPut("/fornecedor/{id}", [Authorize] async (Guid id, MinimalContextDb context, Fornecedor fornecedor) =>
    {
        ...
        if (fornecedorBanco == null) Results.NotFound();
